...
@section('content')
    <div class="page-wrapper">
                    ...
                    <div class="breadcrumb-path mb-4">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="index.html"><img src="{{ asset('/img/dash.png') }}" class="mr-2"
                ...
                <div class="col-xl-12 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="card-titles">Personal information personnels</h2>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-12 col-sm-12 col-12">
                                    <div class="form-group">
                                        <label>Review Name <span class="mandatory">*</span>
                                        </label>
      ...
      Explain What This Review Is To, How It's Going To Be Run, How Everyone Can Prepare.	</textarea
                              >
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-xl-12 col-sm-12 col-12">
                            <div class="form-group">
                              <textarea rows="4" cols="50">
      Add Questions For The People Being Reviewed.	</textarea
                              >
                            </div>
                          </div>
                        </div>
