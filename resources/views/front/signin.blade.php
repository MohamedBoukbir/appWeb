                        ...
                        <div class="form signup">
                            <div class="form-content">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="field input-field">
                                        <input id="password"  type="password" placeholder="Create password" class="password @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                                        @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
